...
export const getComics = () => {
  return async function (dispatch) {
    const response = await fetch(
      `https://gateway.marvel.com:443/v1/public/comics?hasDigitalIssue=false&ts=1&format=digital%20comic&formatType=comic&noVariants=true&dateRange=2016-01-01%2C2023-01-01&orderBy=onsaleDate&limit=100&apikey=${apiKey}&hash=2e9ddca8f096b65c3be62fc4c64a2df4`
    );
